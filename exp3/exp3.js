...
var ambientLight = vec3(0.5, 1.0, 1.0); 	// 环境光
...
window.onload = function main(){
	...
	u_Ke = gl.getUniformLocation(program, "u_Ke");
	u_Ns = gl.getUniformLocation(program, "u_Ns");
	...
	canvas.addEventListener("mousemove", function(event){
		//document.getElementById("demo").innerHTML=document.getElementById("port11").value;
		ambientLight[0]=document.getElementById("port11").value/256;
		ambientLight[1]=document.getElementById("port12").value/256;
		ambientLight[2]=document.getElementById("port13").value/256;
		lightPosition[0]=document.getElementById("port21").value;
		lightPosition[1]=document.getElementById("port22").value;
		lightPosition[2]=document.getElementById("port23").value;
		//document.getElementById("demo").innerHTML=ambientLight[0];
		//document.getElementById("demo2").innerHTML=u_AmbientLight[0];
		render();
	} );
